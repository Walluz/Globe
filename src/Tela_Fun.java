...
public class Tela_Fun {
    ...
    static String rg1;
    static String end1;
    static String bairro1;
    static String cidade1;
    static String estado1;
    static String pais1;
    static String tel_1_1;
    static String tel_2_1;
    static String matri1;
    static String cargo;
    static String sal;

    static void verde(int x) {
    ...
    static void logoart() {
        ...
        Fjalp2.getTerminal().escreva("    ______");
    ...
    static void selecaodecadastro() throws Exception {
        ...
        Fjalp2.getTerminal().caixa(26, 54, 18, 2);
        ...
        Fjalp2.getTerminal().escreva("Cargo:");
        Fjalp2.getTerminal().caixa(35, 40, 20, 2);
        Fjalp2.getTerminal().setPosicaoCursor(39, 34);
        Fjalp2.getTerminal().escreva("Salario" + " R$:");
        Fjalp2.getTerminal().caixa(38, 45, 15, 2);
    ...
    static void cadastro_fun() throws Exception {
    ...
    static void cadastrar() throws Exception {
        ...
        Fjalp2.getTerminal().setCorFundo(CorFundo.BRANCO);
        nome1 = Fjalp2.getTerminal().leiaString();
        Fjalp2.getTerminal().setPosicaoCursor(18, 40);
        cpf1 = Fjalp2.getTerminal().leiaString();
        Fjalp2.getTerminal().setPosicaoCursor(18, 60);
        rg1 = Fjalp2.getTerminal().leiaString();
        Fjalp2.getTerminal().setPosicaoCursor(21, 40);
        end1 = Fjalp2.getTerminal().leiaString();
        Fjalp2.getTerminal().setPosicaoCursor(24, 43);
        bairro1 = Fjalp2.getTerminal().leiaString();
        Fjalp2.getTerminal().setPosicaoCursor(24, 63);
        cidade1 = Fjalp2.getTerminal().leiaString();
        Fjalp2.getTerminal().setPosicaoCursor(27, 43);
        estado1 = Fjalp2.getTerminal().leiaString();
        Fjalp2.getTerminal().setPosicaoCursor(27, 56);
        pais1 = Fjalp2.getTerminal().leiaString();
        Fjalp2.getTerminal().setPosicaoCursor(30, 42);
        tel_1_1 = Fjalp2.getTerminal().leiaString();
        Fjalp2.getTerminal().setPosicaoCursor(30, 62);
        tel_2_1 = Fjalp2.getTerminal().leiaString();
        Fjalp2.getTerminal().setPosicaoCursor(33, 46);
        matri1 = Fjalp2.getTerminal().leiaString();
        Fjalp2.getTerminal().setPosicaoCursor(36, 42);
        cargo = Fjalp2.getTerminal().leiaString();
        Fjalp2.getTerminal().setPosicaoCursor(39, 47);
        sal = Fjalp2.getTerminal().leiaString();
        Funcoes.escrever("funcionarios.txt", nome1 + "," + cpf1 + "," + rg1 + "," + end1 + "," + bairro1 + "," + cidade1 + "," + estado1 + "," + pais1 + "," + tel_1_1 + "," + tel_2_1 + "," + matri1 + "," + cargo + "," + sal + "\r\n");
        Fjalp2.getTerminal().resetCor();
        selecaodecadastro();
    }
    ...
    static void selecaodeconsultas() throws Exception {
        ...
        Fjalp2.getTerminal().caixa(23, 26, 30, 2);
        Fjalp2.getTerminal().setPosicaoCursor(24, 28);
        Fjalp2.getTerminal().escreva("Nome / Cargo");
        Fjalp2.getTerminal().caixa(23, 57, 17, 2);
        Fjalp2.getTerminal().setPosicaoCursor(24, 59);
        Fjalp2.getTerminal().escreva("Matricula");
        op = 0;
        tecla = 0;
        Fjalp2.getTerminal().setCor(CorFonte.VERMELHO, CorFundo.PRETO);
    ...
    static void consultar() throws Exception {
        ...
        String[][] procurado = Funcoes.buscavendedor("funcionarios.txt");
        int linha = 26;
        for (x = 0; x < procurado.length; x++) {
            if (nome.equalsIgnoreCase(procurado[x][0])) {
                Fjalp2.getTerminal().setPosicaoCursor(linha, 28);
                Fjalp2.getTerminal().escreva(procurado[x][0] + "/" + procurado[x][2]);
                Fjalp2.getTerminal().setPosicaoCursor(linha, 59);
    ...
    static void tabelaalteracao() {
        ...
        Fjalp2.getTerminal().setPosicaoCursor(45, 27);
        Fjalp2.getTerminal().escreva("11 - Cargo");
        Fjalp2.getTerminal().setPosicaoCursor(47, 27);
        Fjalp2.getTerminal().escreva("12 - Salario");
    ...
    static void alterar() throws Exception {
        ...
        Fjalp2.getTerminal().setPosicaoCursor(18, 35);
        nome = Fjalp2.getTerminal().leiaString();
        String alterar[][] = Funcoes.infovendedor("funcionarios.txt");
        ...
        if (encontrado != 0) {
            ...
            Funcoes.sobreescrever("funcionarios.txt", "");
            for (int y = 0; y < alterar.length; y++) {
                for (int z = 0; z < 13; z++) {
                    if (z == 12) {
                        Funcoes.escrever("funcionarios.txt", alterar[y][z] + "\r\n");
                    } else {
                        Funcoes.escrever("funcionarios.txt", alterar[y][z] + ",");
                    }
                }
    ...
    static void excluir() throws Exception {
        ...
        Fjalp2.getTerminal().setPosicaoCursor(18, 35);
        nome = Fjalp2.getTerminal().leiaString();
        String[][] excluir = Funcoes.infovendedor("funcionarios.txt");
                ...
                for (int y = 0; y < excluir.length; y++) {
                    for (int z = 0; z < excluir[0].length; z++) {
                      if (excluir[y][z].equals("")) {
                            ...
                            if (z == 12) {
                                Funcoes.escrever("funcionarios.txt", excluir[y][z] + "\r\n");
                            } else {
                                Funcoes.escrever("funcionarios.txt", excluir[y][z] + ",");
                          }
                        }
    ...
    public static void Tela_Funcionario() throws Exception {
